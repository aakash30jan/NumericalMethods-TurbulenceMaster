...
n=9 ! is the order of polynomial (this means that there should atleast be n+1 values to create a polynomial)
m=10!number of values to interpolate after creating the polynomial
